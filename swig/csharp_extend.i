...
%ignore *::TY_PATTERN_SINE_TYPE;
%ignore *::TY_PATTERN_GRAY_TYPE;
%ignore *::TY_PATTERN_BIN_TYPE;
%ignore *::TY_PATTERN_EMPTY_TYPE;

enum swig_TY_PATTERN_EMPTY_TYPE_LIST
{
    TY_PATTERN_SINE_TYPE = 0,
    TY_PATTERN_GRAY_TYPE = 1,
    TY_PATTERN_BIN_TYPE = 2,
    TY_PATTERN_EMPTY_TYPE = -1,
}swig_TY_PATTERN_EMPTY_TYPE_LIST;

ENUM_UINT_TYPE_DEFINE(swig_TY_PATTERN_EMPTY_TYPE_LIST)
