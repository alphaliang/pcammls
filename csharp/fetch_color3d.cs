...
namespace pcammls_fetch_frame
{
    ...
    class Program
    {
        ...
        static void FetchFrameLoop(IntPtr handle)
        {
            ...
            TY_VECT_3F_ARRAY pcolor3dArray = new TY_VECT_3F_ARRAY(color_width * color_height);
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    if ((depth_enable) && (color_enable))
                    {
                        ...
                        float fz = pcolor3dArray.getitem(offset).z;

                        Console.WriteLine(string.Format("The color 3d value of the center position of the image :R.{0} G.{1} B.{2} X.{3} Y.{4} Z.{5}", r, g, b, fx, fy, fz));
                    }
